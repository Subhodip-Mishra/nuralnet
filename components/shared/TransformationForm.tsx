...
const TransformationForm = ({ action, data = null,
  ...
  const onSelectFieldHandler = (value: string, onChangeField: (value: string) => void) => {
    const iamgeSize = aspectRatioOptions[value as AspectRatioKey]

    setImage((prevState: any)=> ({
      ...prevState,
      aspectRatio: iamgeSize.aspectRatio,
      width: iamgeSize.width,
      height: iamgeSize.height
    }))
  ...
  const onTransformHandler = async () => {
    ...
    startTransition( async ()=>{
      // await updateCredits(userId, creidtFee)
