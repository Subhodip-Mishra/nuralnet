    ...
    //             secure: true,
    //         })
    //         let expression = 'folder=Cripai';
            
    //         if (searchQuery) {
    //             expression += `AND ${searchQuery}`
    //         }

    //         const { recources } = await cloudinary.search.expression(expression).execute();

    //         const recourcesIds = recources.map((recource:any) => recource.public_id);
